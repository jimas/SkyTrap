package com.jimas.weixin.skytrap.repository.api.response;
...
public class PageResponse<T> implements Serializable {
    ...
    private static final long serialVersionUID = 858839367639478604L;
    ...
    public PageResponse(int total, int pageNumber) {
        init(total, pageNumber, limit);
    }
     
    public PageResponse(int total, int pageNumber, int limit) {
        init(total, pageNumber, limit);
    }
    ...
    public String toString(){
        ...
        str+=",list="+list+" list size:"+(null==list?0:list.size());
        str+="]";
